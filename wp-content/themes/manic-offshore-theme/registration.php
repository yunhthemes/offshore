            ...
            <div class="shareholder">
                ...
                <div class="field-container">
                    <div class="custom-input-container-left pull-left">
                        ...
                        <div class="vc_empty_space" style="height: 10px"><span class="vc_empty_space_inner"></span></div>            
                        <input type="text" name="shareholder_2_telephone" data-selector="shareholder" data-shareholder-field="telephone" data-shareholder-id="2" class="shareholder-telephone person-input custom-input-class">                
                    </div>
                    <div class="custom-input-container-right pull-right">
                ...
                <div class="cloneable">
                    <div class="field-container">
                        <div class="custom-input-container-left pull-left">
                            ...
                            <div class="vc_empty_space" style="height: 10px"><span class="vc_empty_space_inner"></span></div>            
                            <input type="text" name="shareholder_3_telephone" data-selector="shareholder" data-shareholder-field="telephone" data-shareholder-id="3" class="shareholder-telephone person-input custom-input-class">
                        </div>
                        <div class="custom-input-container-right pull-right">
