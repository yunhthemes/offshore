...
<script>
	jQuery(document).ready(function($){
		...
		$(".field_home-address").find("input").attr("placeholder", "Street 1");
		$(".field_home-address-2").find("input").attr("placeholder", "Street 2");
		$(".field_home-address-3").find("input").attr("placeholder", "Street 3");
		...
		$(".field_postal-address").find("input").attr("placeholder", "Street 1");
		$(".field_postal-address-2").find("input").attr("placeholder", "Street 2");
		$(".field_postal-address-3").find("input").attr("placeholder", "Street 3");
