<?php
namespace Deploy\MikadofModules\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = deploy_mikado_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
