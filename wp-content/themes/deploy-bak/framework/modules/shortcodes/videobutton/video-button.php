<?php
namespace Deploy\MikadofModules\VideoButton;
...
class VideoButton implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = deploy_mikado_get_shortcode_module_template_part('templates/video-button-template', 'videobutton', '', $params);
