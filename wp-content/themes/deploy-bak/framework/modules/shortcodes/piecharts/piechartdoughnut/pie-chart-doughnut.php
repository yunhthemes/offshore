<?php
namespace Deploy\MikadofModules\PieCharts\PieChartDoughnut;
...
class PieChartDoughnut implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => 'Mikado Pie Chart 3 (Doughnut)',
			'base' => $this->getBase(),
			'category' => 'by MIKADO',
	...
	public function render($atts, $content = null) {
		...
		$html = deploy_mikado_get_shortcode_module_template_part('templates/pie-chart-doughnut', 'piecharts/piechartdoughnut', '', $params);
