<?php
namespace Deploy\MikadofModules\PieCharts\PieChartPie;
...
class PieChartPie implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = deploy_mikado_get_shortcode_module_template_part('templates/pie-chart-pie', 'piecharts/piechartpie', '', $params);
