...
if ( ! function_exists('deploy_mikado_sidearea_options_map') ) {

	function deploy_mikado_sidearea_options_map() {
		...
		$side_area_panel = deploy_mikado_add_admin_panel(
			array(
				'title' => 'Side Area',
				'name' => 'side_area',
		...
		$side_area_width_container = deploy_mikado_add_admin_container(
			array(
				'parent' => $side_area_panel,
		...
		$side_area_slide_with_content_container = deploy_mikado_add_admin_container(
			array(
				'parent' => $side_area_panel,
		...
		$side_area_icon_style_group = deploy_mikado_add_admin_group(
			array(
				'parent' => $side_area_panel,
		...
		$side_area_icon_style_row1 = deploy_mikado_add_admin_row(
			array(
		...
		$side_area_icon_style_row2 = deploy_mikado_add_admin_row(
			array(
				'parent'		=> $side_area_icon_style_group,
		...
		$side_area_icon_style_row3 = deploy_mikado_add_admin_row(
			array(
				'parent'		=> $side_area_icon_style_group,
		...
		$icon_spacing_group = deploy_mikado_add_admin_group(
			array(
				'parent' => $side_area_panel,
		...
		$icon_spacing_row = deploy_mikado_add_admin_row(
			array(
		...
		$side_area_icon_border_container = deploy_mikado_add_admin_container(
			array(
				'parent' => $side_area_panel,
		...
		$border_style_group = deploy_mikado_add_admin_group(
			array(
		...
		$border_style_row_1 = deploy_mikado_add_admin_row(
			array(
		...
		$border_style_row_2 = deploy_mikado_add_admin_row(
			array(
				'parent'		=> $border_style_group,
		...
		$padding_group = deploy_mikado_add_admin_group(
			array(
				'parent' => $side_area_panel,
				'name' => 'padding_group',
				'title' => 'Padding',
		...
		$padding_row = deploy_mikado_add_admin_row(
			array(
		...
		$title_group = deploy_mikado_add_admin_group(
			array(
				'parent' => $side_area_panel,
				'name' => 'title_group',
				'title' => 'Title',
		...
		$title_row_1 = deploy_mikado_add_admin_row(
			array(
				'parent' => $title_group,
				'name' => 'title_row_1',
			)
		...
		$title_row_2 = deploy_mikado_add_admin_row(
			array(
				'parent' => $title_group,
				'name' => 'title_row_2',
				'next' => true
		...
		$text_group = deploy_mikado_add_admin_group(
			array(
				'parent' => $side_area_panel,
				'name' => 'text_group',
				'title' => 'Text',
		...
		$text_row_1 = deploy_mikado_add_admin_row(
			array(
				'parent' => $text_group,
				'name' => 'text_row_1',
			)
		...
		$text_row_2 = deploy_mikado_add_admin_row(
			array(
				'parent' => $text_group,
				'name' => 'text_row_2',
				'next' => true
		...
		$widget_links_group = deploy_mikado_add_admin_group(
			array(
				'parent' => $side_area_panel,
		...
		$widget_links_row_1 = deploy_mikado_add_admin_row(
			array(
		...
		$widget_links_row_2 = deploy_mikado_add_admin_row(
			array(
				'parent' => $widget_links_group,
		...
		$widget_links_row_3 = deploy_mikado_add_admin_row(
			array(
				'parent' => $widget_links_group,
		...
		$side_area_bottom_border_container = deploy_mikado_add_admin_container(
			array(
				'parent' => $side_area_panel,
	...
	add_action('deploy_mikado_options_map', 'deploy_mikado_sidearea_options_map', 4);
