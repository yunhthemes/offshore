...
if(!function_exists('deploy_mikado_search_options_map')) {

	function deploy_mikado_search_options_map() {
		...
		$search_panel = deploy_mikado_add_admin_panel(
			array(
				'title' => 'Search',
				'name'  => 'search',
				'page'  => '_search_page'
		...
		deploy_mikado_add_admin_field(
			array(
				...
				'options'       => deploy_mikado_icon_collections()->getIconCollectionsExclude(array(
					'linea_icons',
					'dripicons'
				))
			)
		...
		$search_height_container = deploy_mikado_add_admin_container(
			array(
				'parent'          => $search_panel,
		...
		$search_animation_container = deploy_mikado_add_admin_container(
			array(
				'parent'          => $search_panel,
		...
		$search_icon_color_group = deploy_mikado_add_admin_group(
			array(
				'parent'      => $search_panel,
				'title'       => 'Icon Colors',
		...
		$search_icon_color_row = deploy_mikado_add_admin_row(
			array(
		...
		$search_icon_color_row2 = deploy_mikado_add_admin_row(
			array(
				'parent' => $search_icon_color_group,
		...
		$search_icon_background_group = deploy_mikado_add_admin_group(
			array(
				'parent'      => $search_panel,
		...
		$search_icon_background_row = deploy_mikado_add_admin_row(
			array(
		...
		$enable_search_icon_text_container = deploy_mikado_add_admin_container(
			array(
				'parent'          => $search_panel,
		...
		$enable_search_icon_text_group = deploy_mikado_add_admin_group(
			array(
		...
		$enable_search_icon_text_row = deploy_mikado_add_admin_row(
			array(
		...
		$enable_search_icon_text_row2 = deploy_mikado_add_admin_row(
			array(
				'parent' => $enable_search_icon_text_group,
		...
		$enable_search_icon_text_row3 = deploy_mikado_add_admin_row(
			array(
				'parent' => $enable_search_icon_text_group,
		...
		$search_icon_spacing_group = deploy_mikado_add_admin_group(
			array(
				'parent'      => $search_panel,
				'title'       => 'Icon Spacing',
		...
		$search_icon_spacing_row = deploy_mikado_add_admin_row(
			array(
		...
		$search_input_text_group = deploy_mikado_add_admin_group(
			array(
				'parent'      => $search_panel,
		...
		$search_input_text_row = deploy_mikado_add_admin_row(
			array(
		...
		$search_input_text_row2 = deploy_mikado_add_admin_row(
			array(
				'parent' => $search_input_text_group,
		...
		$search_label_text_group = deploy_mikado_add_admin_group(
			array(
				'parent'      => $search_panel,
		...
		$search_label_text_row = deploy_mikado_add_admin_row(
			array(
		...
		$search_label_text_row2 = deploy_mikado_add_admin_row(
			array(
				'parent' => $search_label_text_group,
		...
		$search_icon_group = deploy_mikado_add_admin_group(
			array(
				'parent'      => $search_panel,
				'title'       => 'Search Icon',
		...
		$search_icon_row = deploy_mikado_add_admin_row(
			array(
		...
		$search_close_icon_group = deploy_mikado_add_admin_group(
			array(
				'parent'      => $search_panel,
				'title'       => 'Search Close',
		...
		$search_close_icon_row = deploy_mikado_add_admin_row(
			array(
		...
		$search_bottom_border_group = deploy_mikado_add_admin_group(
			array(
				'parent'      => $search_panel,
		...
		$search_bottom_border_row = deploy_mikado_add_admin_row(
			array(
	...
	add_action('deploy_mikado_options_map', 'deploy_mikado_search_options_map', 5);
