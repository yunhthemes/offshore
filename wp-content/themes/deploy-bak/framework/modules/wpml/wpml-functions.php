...
if(!function_exists('deploy_mikado_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function deploy_mikado_get_wpml_pages_for_current_page() {
...
if(!function_exists('mkdf_disable_wpml_css')) {
    function mkdf_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'mkdf_disable_wpml_css');
}