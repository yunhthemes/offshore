...
include get_template_directory().'/framework/lib//mkd.icons/mkd.iconcollection.interface.php';
include get_template_directory().'/framework/lib//mkd.icons/mkd.fontawesome.php';
include get_template_directory().'/framework/lib//mkd.icons/mkd.fontelegant.php';
include get_template_directory().'/framework/lib//mkd.icons/mkd.ionicons.php';
include get_template_directory().'/framework/lib//mkd.icons/mkd.lineaicons.php';
include get_template_directory().'/framework/lib//mkd.icons/mkd.simplelineicons.php';
include get_template_directory().'/framework/lib//mkd.icons/mkd.dripicons.php';

/*
  Class: DeployMikadoIconCollections
...
class DeployMikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new DeployMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new DeployMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new DeployMikadoIconsIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new DeployMikadoIconsLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new DeployMikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new DeployMikadoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function enqueueStyles() {
        if(is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach($this->iconCollections as $collection_key => $collection_obj) {
                wp_enqueue_style('mkdf-deploy-'.$collection_key, $collection_obj->styleUrl);
            }
        }
    }
...
$mkdDeployIconCollections = DeployMikadoIconCollections::get_instance();