...
if ( ! function_exists('deploy_mikado_fonts_options_map') ) {
	/**
	 * Font options page
	 */
	function deploy_mikado_fonts_options_map() {
		 ...
		 * Headings
		 */
		$panel_headings = deploy_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => 'Headings'
		...
		//H1
		$group_heading_h1 = deploy_mikado_add_admin_group(array(
		...
		$row_heading_h1_1 = deploy_mikado_add_admin_row(array(
		...
		$row_heading_h1_2 = deploy_mikado_add_admin_row(array(
		...
		//H2
		$group_heading_h2 = deploy_mikado_add_admin_group(array(
		...
		$row_heading_h2_1 = deploy_mikado_add_admin_row(array(
		...
		$row_heading_h2_2 = deploy_mikado_add_admin_row(array(
		...
		//H3
		$group_heading_h3 = deploy_mikado_add_admin_group(array(
		...
		$row_heading_h3_1 = deploy_mikado_add_admin_row(array(
		...
		$row_heading_h3_2 = deploy_mikado_add_admin_row(array(
		...
		//H4
		$group_heading_h4 = deploy_mikado_add_admin_group(array(
		...
		$row_heading_h4_1 = deploy_mikado_add_admin_row(array(
		...
		$row_heading_h4_2 = deploy_mikado_add_admin_row(array(
		...
		//H5
		$group_heading_h5 = deploy_mikado_add_admin_group(array(
		...
		$row_heading_h5_1 = deploy_mikado_add_admin_row(array(
		...
		$row_heading_h5_2 = deploy_mikado_add_admin_row(array(
		...
		//H6
		$group_heading_h6 = deploy_mikado_add_admin_group(array(
		...
		$row_heading_h6_1 = deploy_mikado_add_admin_row(array(
		...
		$row_heading_h6_2 = deploy_mikado_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = deploy_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
				'title' => 'Text'
		...
		$group_text = deploy_mikado_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> 'Paragraph',
		...
		$row_text_1 = deploy_mikado_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$row_text_2 = deploy_mikado_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_link = deploy_mikado_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> 'Links',
		...
		$row_link_1 = deploy_mikado_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		$row_link_2 = deploy_mikado_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		deploy_mikado_add_admin_field(array(
			...
			'options'		=> deploy_mikado_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	...
	add_action( 'deploy_mikado_options_map', 'deploy_mikado_fonts_options_map', 2);
