...
if(!function_exists('deploy_mikado_social_options_map')) {

    function deploy_mikado_social_options_map() {
         ...
         * Enable Social Share
         */
        $panel_social_share = deploy_mikado_add_admin_panel(array(
            'page'  => '_social_page',
        ...
        $panel_show_social_share_on = deploy_mikado_add_admin_panel(array(
            'page'            => '_social_page',
         ...
         */
        $panel_social_networks = deploy_mikado_add_admin_panel(array(
            'page'            => '_social_page',
        ...
        $enable_facebook_share_container = deploy_mikado_add_admin_container(array(
        ...
        $enable_twitter_share_container = deploy_mikado_add_admin_container(array(
        ...
        $enable_google_plus_container = deploy_mikado_add_admin_container(array(
        ...
        $enable_linkedin_container = deploy_mikado_add_admin_container(array(
        ...
        $enable_tumblr_container = deploy_mikado_add_admin_container(array(
        ...
        $enable_pinterest_container = deploy_mikado_add_admin_container(array(
        ...
        $enable_vk_container = deploy_mikado_add_admin_container(array(
        ...
        if(defined('MIKADOF_TWITTER_FEED_VERSION')) {
            $twitter_panel = deploy_mikado_add_admin_panel(array(
                'title' => 'Twitter',
                'name'  => 'panel_twitter',
                'page'  => '_social_page'
            ));

            deploy_mikado_add_admin_twitter_button(array(
                'name'   => 'twitter_button',
        ...
        if(defined('MIKADOF_INSTAGRAM_FEED_VERSION')) {
            $instagram_panel = deploy_mikado_add_admin_panel(array(
                'title' => 'Instagram',
                'name'  => 'panel_instagram',
                'page'  => '_social_page'
            ));

            deploy_mikado_add_admin_instagram_button(array(
    ...
    add_action('deploy_mikado_options_map', 'deploy_mikado_social_options_map', 13);
