...
class DeployMikadoSkin extends DeployMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to deploy_mikado_admin_scripts_init and deploy_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('deploy_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('deploy_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('deploy_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('deploy_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('deploy_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('deploy_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            deploy_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            deploy_mikado_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        $tab    		= deploy_mikado_get_admin_tab();
        $active_page 	= deploy_mikado_framework()->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param DeployMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkdf-options-page mkdf-page">
            <?php $this->getHeader(deploy_mikado_get_theme_info_item('Name'), deploy_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkdf-page-content-wrapper">
                <div class="mkdf-page-content">
                    <div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
