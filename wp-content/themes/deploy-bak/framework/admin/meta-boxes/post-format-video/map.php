...
$video_post_format_meta_box = deploy_mikado_add_meta_box(
	array(
		'scope' =>	array('post'),
...
$mkdf_video_embedded_container = deploy_mikado_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
...
$mkdf_video_self_hosted_container = deploy_mikado_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
