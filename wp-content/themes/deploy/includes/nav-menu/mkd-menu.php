...
add_filter( 'wp_setup_nav_menu_item', 'deploy_mikado_add_custom_nav_fields');

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'deploy_mikado_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'deploy_mikado_edit_walker', 10, 2 );


function deploy_mikado_add_custom_nav_fields( $menu_item ) {
 ...
 * @return      void
*/
function deploy_mikado_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
 ...
 * @return      void
*/
function deploy_mikado_edit_walker($walker,$menu_id) {

	return 'DeployMikado_Walker_Nav_Menu_Edit_Custom';
		
}

include_once get_template_directory().'/includes/nav-menu/edit_custom_walker.php';

/**
 * Include custom walkers
 */
include_once get_template_directory().'/includes/nav-menu/top-navigation-walker.php';
include_once get_template_directory().'/includes/nav-menu/mobile-navigation-walker.php';
include_once get_template_directory().'/includes/nav-menu/left-right-navigation-walker.php';
include_once get_template_directory().'/includes/nav-menu/sticky-navigation-walker.php';