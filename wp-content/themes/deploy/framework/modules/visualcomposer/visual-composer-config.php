...
if ( ! function_exists('deploy_mikado_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function deploy_mikado_configure_visual_composer() {
	...
	add_action('vc_after_init', 'deploy_mikado_configure_visual_composer');

}


if ( ! function_exists('deploy_mikado_configure_visual_composer_grid_elemets') ) {
	...
	function deploy_mikado_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'deploy_mikado_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('deploy_mikado_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function deploy_mikado_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'deploy_mikado_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Mkdf_Text_Slider_Holder extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Mkdf_Text_Slider_Item extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Mkdf_Info_Card_Slider extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Mkdf_Icon_Slider extends WPBakeryShortCodesContainer {}
...
/*** Row ***/
if ( ! function_exists('deploy_mikado_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function deploy_mikado_vc_row_map()	{
	...
	add_action('vc_after_init', 'deploy_mikado_vc_row_map');
}
