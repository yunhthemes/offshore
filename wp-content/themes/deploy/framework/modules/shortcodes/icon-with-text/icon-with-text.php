<?php
namespace Deploy\MikadofModules\Shortcodes\IconWithText;

use Deploy\MikadofModules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package Deploy\MikadofModules\Shortcodes\IconWithText
 */
...
//            'custom_hover_icon'           => '',
        ...
        return deploy_mikado_get_shortcode_module_template_part('templates/iwt', 'icon-with-text', $params['icon_position'], $params);
    }
    ...
    private function getHolderClasses($params) {
        ...
        if(!empty($params['icon_type'])) {
            $classes[] = 'mkdf-iwt-icon-'.$params['icon_type'];
        }

//        if(!empty($params['custom_icon'])) {
//            $classes[] = 'mkdf-iwt-custom-hover-icon';
//        }
    ...
    private function getContentStyles($params) {
        ...
        if($params['icon_position'] == 'left' && !empty($params['text_left_padding'])) {
            $styles[] = 'padding-left: '.deploy_mikado_filter_px($params['text_left_padding']).'px';
        }

        if($params['icon_position'] == 'right' && !empty($params['text_right_padding'])) {
            $styles[] = 'padding-right: '.deploy_mikado_filter_px($params['text_right_padding']).'px';
        }
