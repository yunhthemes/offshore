<?php
namespace Deploy\MikadofModules\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . deploy_mikado_get_class_attribute($elements_holder_class) . ' ' . deploy_mikado_get_inline_attr($elements_holder_style, 'style'). '>';
