...
if ( ! function_exists('deploy_mikado_portfolio_options_map') ) {

	function deploy_mikado_portfolio_options_map() {
		...
		deploy_mikado_add_admin_field(array(
			...
			'type'          => 'yesno',
			'label'         => 'Hide Author',
			'description'   => 'Enabling this option will disable author info on Single Projects.',
			'parent'        => $panel,
			'default_value' => 'no'
		));
		...
		$container_navigate_category = deploy_mikado_add_admin_container(array(
	...
	add_action( 'deploy_mikado_options_map', 'deploy_mikado_portfolio_options_map', 12);
