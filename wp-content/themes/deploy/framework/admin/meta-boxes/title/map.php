...
$title_meta_box = deploy_mikado_add_meta_box(
	array(
...
$show_title_area_meta_container = deploy_mikado_add_admin_container(
	array(
		'parent'          => $title_meta_box,
...
$title_area_type_meta_container = deploy_mikado_add_admin_container(
	array(
		'parent'          => $show_title_area_meta_container,
...
deploy_mikado_add_meta_box_field(
	array(
		'name'          => 'mkdf_enable_title_text_separator_meta',
		'type'          => 'yesno',
		'label'         => 'Enable Title Text Separator',
		'default_value' => 'no',
		'description'   => 'Enabling this option will enable title text separator',
		'parent'        => $title_area_type_meta_container
	)
);
...
$hide_background_image_meta_container = deploy_mikado_add_admin_container(
	array(
		'parent'          => $show_title_area_meta_container,
...
$title_area_background_image_responsive_meta_container = deploy_mikado_add_admin_container(
	array(
		'parent'          => $hide_background_image_meta_container,
...
deploy_mikado_add_meta_box_field(
	array(
		'name'          => 'mkdf_disable_title_box_shadow_meta',
		'type'          => 'yesno',
		'label'         => 'Disable Title Area Shadow',
		'default_value' => 'no',
		'description'   => 'Enabling this option will disable title area shadow',
		'parent'        => $show_title_area_meta_container
	)
);