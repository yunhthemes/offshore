<div class="mkdf-page-header page-header clearfix">
    ...
    <div class="mkdf-theme-name pull-left" >
        <img src="<?php echo esc_url(deploy_mikado_get_skin_uri() . '/assets/img/logo.png'); ?>"
             alt="<?php esc_attr_e('mkd_logo', 'deploy') ?>" class="mkdf-header-logo pull-left"/>
        <h1 class="pull-left">
        ...
        <div class="mkdf-top-section-holder-inner">
            ...
            <div class="mkdf-top-buttons-holder">
                <?php if($showSaveButton) { ?>
                    <input type="button" id="mkd_top_save_button" class="btn btn-info btn-sm" value="<?php esc_html_e('Save Changes', 'deploy'); ?>"/>
                <?php } ?>
            </div>
        </div>
    </div>
