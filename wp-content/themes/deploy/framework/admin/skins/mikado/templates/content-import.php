                        ...
                        <div class="mkdf-page-form-section-holder">
                            ...
                            <div class="mkdf-page-form-section">
                                ...
                                <div class="mkdf-section-content">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="import_load"><span><?php esc_html_e('The import process may take some time. Please be patient.', 'deploy') ?> </span><br />
                            ...
                            <div class="mkdf-page-form-section mkdf-import-button-wrapper">
                                ...
                                <div class="alert alert-warning">
                                    <strong><?php esc_html_e('Important notes:', 'deploy') ?></strong>
                                    <ul>
                                        <li><?php esc_html_e('Please note that import process will take time needed to download all attachments from demo web site.', 'deploy'); ?></li>
                                        <li> <?php esc_html_e('If you plan to use shop, please install WooCommerce before you run import.', 'deploy')?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            $(document).on('click', '#import_demo_data', function(e) {
                ...
                if (confirm('Are you sure, you want to import Demo Data now?')) {
                    ...
                    if(import_opt == 'content'){
                        for(var i=1;i<10;i++){
                            var str;
                            if (i < 10) str = 'deploy_content_0'+i+'.xml';
                            else str = 'deploy_content_'+i+'.xml';
                            jQuery.ajax({
                                type: 'POST',
                                url: ajaxurl,
                                data: {
