...
if ( ! function_exists('deploy_mikado_page_options_map') ) {

    function deploy_mikado_page_options_map() {
        ...
        $panel_sidebar = deploy_mikado_add_admin_panel(
            array(
                'page'  => '_page_page',
                'name'  => 'panel_sidebar',
                'title' => 'Design Style'
	    ...
	    $panel_widgets = deploy_mikado_add_admin_panel(
		    array(
			    'page'  => '_page_page',
			    'name'  => 'panel_widgets',
			    'title' => 'Widgets'
	    ...
	    $group_sidebar_padding = deploy_mikado_add_admin_group(array(
		    'name'   => 'group_sidebar_padding',
		    'title'  => 'Padding',
		    'parent' => $panel_widgets
	    ));

	    $row_sidebar_padding = deploy_mikado_add_admin_row(array(
    ...
    add_action( 'deploy_mikado_options_map', 'deploy_mikado_page_options_map', 7);
