...
/**
 * Class MikadofInstagramHelper
 */
class MikadofInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines mkdf_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('mkdf_instagram_image_atts',
            array(
                'class' => $imageSize,
