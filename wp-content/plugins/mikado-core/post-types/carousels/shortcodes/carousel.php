...
class Carousel implements Lib\ShortcodeInterface {
        ...
        vc_map( array(
            ...
            'params' => array(
                ...
                array(
                    ...
                    'admin_label' => true,
                    'description' => '',
                    'dependency'  => array('element' => 'show_in_two_rows', 'not_empty' => true)
                ),
            )
        ) );
    ...
    public function render($atts, $content = null) {
        ...
        if ($carousel !== '') {
            ...
            $html .= '<div class="mkdf-carousel" ' .  deploy_mikado_get_inline_attrs($carousel_data_attributes) . '>';
    ...
    private function getCarouselItemData($item_id, $params) {
        ...
        if (get_post_meta($item_id, 'mkdf_carousel_image', true) !== '') {
            $carousel_item['image'] = get_post_meta($item_id, 'mkdf_carousel_image', true);
            $carousel_item['image_id'] = mkd_core_get_attachment_id_from_url($carousel_item['image']);
        } else {
            $carousel_item['image'] = '';
        }

        if ($params['image_animation'] == 'image-change' && get_post_meta($item_id, 'mkdf_carousel_hover_image', true) !== '') {
            $carousel_item['hover_image'] = get_post_meta($item_id, 'mkdf_carousel_hover_image', true);
        ...
        if (get_post_meta($item_id, 'mkdf_carousel_item_link', true) != '') {
            $carousel_item['link'] = get_post_meta($item_id, 'mkdf_carousel_item_link', true);
        } else {
            $carousel_item['link'] = '';
        }

        if (get_post_meta($item_id, 'mkdf_carousel_item_target', true) != '') {
            $carousel_item['target'] = get_post_meta($item_id, 'mkdf_carousel_item_target', true);
        } else {
