...
class MikadofTwitterWidget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'mkdf_twitter_widget',
            'Mikadof Twitter Widget',
            array( 'description' => __( 'Display tweets', 'mkd_twitter_feed' ) )
        );
    ...
    public function widget($args, $instance) {
        ...
        if($twitter_api->hasUserConnected()) {
            ...
            _e('It seams that you haven\'t connected with your Twitter account', 'mkd_twitter_feed');
        }
