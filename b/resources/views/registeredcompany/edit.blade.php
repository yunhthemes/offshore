	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">				
				...
				<a href="{{ route('admin.registeredcompany.index') }}"><button class="custom-submit-class">Return to pending orders</button></a>

				{{ Form::open([ 'route' => ['admin.registeredcompany.update', $company->id ], 'method' => 'put', 'id' => 'edit_registered_company' ]) }}	
					<div class="space50"></div>
					<div class="labels">
						<div class="row">
