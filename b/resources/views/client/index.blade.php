	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<a href="{{ route('admin.client.create') }}"><button class="custom-submit-class">Add a person</button></a>					
					              	...
					              	@foreach($persons as $k => $person)
					                    <tr id="id-{{$person->id}}" class="person-id list-item box">
					                    	...
					                    	<td>
				                    	 	...
				                    	 	<td><a href="{{ route('admin.client.show', $person->id) }}"><button class="custom-submit-class">View</button></a><a href="{{ route('admin.client.edit', $person->id) }}"><button class="custom-submit-class">Edit</button></a></td>		                    						
					                    </tr> 
					              	@endforeach			              						
					            @endif
							</tbody>
