...
class CreateCompanywpuserSecretariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('companywpuser_secretaries', function (Blueprint $table) {
            $table->increments('id');            
    ...
    {
        //
        Schema::drop('companywpuser_secretaries');
    }
}
